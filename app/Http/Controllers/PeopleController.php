...
class PeopleController extends Controller
{
    ...
    public function index()
    {
        ...
        $organization = GreenBook::leftjoin('organizations', 'greenbook.organization_code', '=', 'organizations.organizations_id')->select('organizations.name as organization_name')->distinct()->get(['organization_name']);
        $organization_type='';
    ...
    public function organization_find($id, $people_id)
    {
        ...
        return view('frontend.organization_people', compact('organization', 'people', 'entity'));
    }
