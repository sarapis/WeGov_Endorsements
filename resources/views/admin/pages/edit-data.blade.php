...
@section('template_title') Edit Data Page
@endsection 
                    ...
                    <div class="box-body">
                     <!--   <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Content" id="summernote" name="body" cols="50" rows="10" style="display: none;">{!! $data->body !!}</textarea>
                        ...
                        {{Form::close()}}
                        <script>
                            var content = <?php print_r(json_encode($data->body)) ?>;
