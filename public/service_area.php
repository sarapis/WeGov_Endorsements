			...
			<div class="content-wrapper">
				...
				<ul>
					...
					<?php
						...
						$sql = "TRUNCATE TABLE service_area;";
						...
						$airtable_url = AIRTABLE_API_URL . AIRTABLE_APP_ID;
							...
							foreach ( $airtable_response['records'] as $record ) {
								...
								$sql = "INSERT INTO service_area (area_id, area_name, area_services, area_description)
								VALUES ( '{$record['id']}', '{$record['fields']['name']}', '{$services}', '{$description}');";
						...
						$sql = "UPDATE services_table SET total_records='". $size ."', last_synced='{$date}' WHERE table_name='Service_area'";
						if ($conn->query($sql) === TRUE) {
