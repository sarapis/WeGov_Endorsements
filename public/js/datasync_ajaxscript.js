    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#api_path').val(data.api_path);
                $('#api_base').val(data.api_base);
                $('#api_key').val(data.api_key);
                $('#notes').val(data.notes);
                if(data.format == "airtable"){
                    $('#api_base').parent().parent().show();
                    $('#api_key').parent().parent().show();
                    $('#api_path').parent().parent().hide();
                }
                else if(data.format == "socrata")
                {
                    $('#api_base').parent().parent().hide();
                    $('#api_key').parent().parent().hide();
                    $('#api_path').parent().parent().show();
                }
                $('#btn-save').val("update");
                $('#myModal').modal('show');
            },
