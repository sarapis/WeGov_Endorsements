			...
			<div class="content-wrapper">
				...
				<ul>
					...
					<?php
						...
						$sql = "TRUNCATE TABLE services_phones;";
						...
						$airtable_url = AIRTABLE_API_URL . AIRTABLE_APP_ID;
							...
							foreach ( $airtable_response['records'] as $record ) {
								...
								$sql = "INSERT INTO services_phones (phone_recordid, services_phone_number, services_phone_locations, services_phone_services, services_phone_organizations, services_phone_contacts, services_phone_extension, services_phone_type, services_phone_language, services_phone_description, services_phone_schedule)
								VALUES ( '{$record['id']}', '{$number}', '{$locations}', '{$services}', '{$organizations}', '{$contacts}', '{$record['fields']['extension']}', '{$record['fields']['type']}', '{$language}', '{$description}', '{$schedule}');";
						...
						$sql = "UPDATE services_table SET total_records='". $size ."', last_synced='{$date}' WHERE table_name='Services_phones'";
						if ($conn->query($sql) === TRUE) {
