...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#project_projectid').val(data.project_projectid);
                $('#project_description').val(data.project_description);
                $('#project_citycost').val(data.project_citycost);
                $('#project_noncitycost').val(data.project_noncitycost);
                $('#project_totalcost').val(data.project_totalcost);
                $('#project_type').val(data.project_type);
                $('#project_lat').val(data.project_lat);
                $('#project_long').val(data.project_long);
                $('#btn-save').val("update");
                $('#myModal').modal('show');
            },
            error: function (data) {
    ...
    // $("#btn-save").click(function (e) {
        ...
        e.preventDefault(); 
        var formData = {
            project_projectid: $('#project_projectid').val(),
            project_description: $('#project_description').val(),
            project_citycost: $('#project_citycost').val(),
            project_noncitycost: $('#project_noncitycost').val(),
            project_totalcost: $('#project_totalcost').val(),
            project_type: $('#project_type').val(),
            project_lat: $('#project_lat').val(),
            project_long: $('#project_long').val(),
        }
