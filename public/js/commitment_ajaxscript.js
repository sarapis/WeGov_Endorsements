...
$(document).ready(function(){
    ...
    $(document).on('click','.open_modal',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                $('#commitment_id').val(data.id);
                $('#budgetline').val(data.budgetline);
                $('#fmsnumber').val(data.fmsnumber);
                $('#description').val(data.description);
                $('#commitmentcode').val(data.commitmentcode);
                $('#commitmentdescription').val(data.commitmentdescription);
                $('#citycost').val(data.citycost);
                $('#noncitycost').val(data.noncitycost);
                $('#btn-save').val("update");
                $('#myModal').modal('show');
            },
            error: function (data) {
    ...
    // $("#btn-save").click(function (e) {
        ...
        e.preventDefault(); 
        var formData = {
            budgetline: $('#budgetline').val(),
            fmsnumber: $('#fmsnumber').val(),
            description: $('#description').val(),
            commitmentcode: $('#commitmentcode').val(),
            commitmentdescription: $('#commitmentdescription').val(),
            citycost: $('#citycost').val(),
            noncitycost: $('#noncitycost').val(),
        }
