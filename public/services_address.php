			...
			<div class="content-wrapper">
				...
				<ul>
					...
					<?php
						...
						$sql = "TRUNCATE TABLE services_address;";
						...
						$airtable_url = AIRTABLE_API_URL . AIRTABLE_APP_ID;
							...
							foreach ( $airtable_response['records'] as $record ) {
								...
								$address_2 = str_replace("'","\'",$record['fields']['address_2']);
								...
								$sql = "INSERT INTO services_address (address_recordid, services_address_1, services_address_2, services_address_city, services_address_state_province, services_address_postalcode, services_address_region, services_address_country, services_address_attention, services_address_type, services_address_locations)
								VALUES ( '{$record['id']}', '{$address_1}', '{$address_2}', '{$record['fields']['city']}', '{$record['fields']['state_province']}', '{$record['fields']['postal_code']}', '{$record['fields']['region']}', '{$record['fields']['country']}', '{$attention}', '{$address_type}', '{$locations}');";
						...
						$sql = "UPDATE services_table SET total_records='". $size ."', last_synced='{$date}' WHERE table_name='Services_address'";
						if ($conn->query($sql) === TRUE) {
