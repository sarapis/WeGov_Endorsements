					...
					<?php
						...
						$airtable_url = AIRTABLE_API_URL . AIRTABLE_APP_ID;
							...
							foreach ( $airtable_response['records'] as $record ) {
								...
								$sql = "INSERT INTO contact (contact_recordid, contact_name, contact_organization, contact_services, contact_title, contact_department, contact_email, contact_phones)
						...
						$sql = "UPDATE services_table SET total_records='". $size ."', last_synced='{$date}' WHERE table_name='contact'";
