...
class ProjectController extends Controller
{
    ...
    {   
        ...
        $organization_id = DB::table('organizations')->where('organizations_id', '=', $project->magency)->first()->organizations_id;
